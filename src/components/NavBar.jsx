...
const NavBar = () => {
  return (
    <nav className='w-full md:w-[85%] max-w-[1232px] px-4 rounded-2xl flex items-center justify-between h-[80px] mx-auto bg-[#1A19194D] backdrop-blur-[8px] border-[1px] border-[#228de557]'>
      <div className='flex gap-4 md:gap-8 items-center justify-start'>
        <NavLink to="/">
          <img src="/Logo- light 1.png" alt="website-logo"/>
        </NavLink>

        <NavLink to="/" className={`w-fit relative capitalize px-2 flex flex-col items-center group`}> 
            <h4 className='text-2xl lg:inline hidden'>movies</h4>
            <img src={StarIcon} alt="star-icon" className='w-6 h-6 inline lg:hidden'/>
            <span className='w-4/5 h-1 bg-[#228EE5] blur-[2px] scale-x-0 group-hover:scale-x-100'></span>
        </NavLink>

        <NavLink to="favorites" className={`w-fit relative capitalize px-2 flex flex-col items-center group`}> 
            <h4 className='text-2xl lg:inline hidden'>Favorites</h4>
      ...
      <div className='flex gap-4 md:gap-8 items-center justify-end'>
        <HeroSearchBar
        linkPath={'search'}/>
        <NavLink className={`w-fit relative px-2 flex flex-col items-center group`}>
