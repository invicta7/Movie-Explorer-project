...
const WatchMovie = ({buttonName, onClick, borderRad}) => {
  return (
    <button
     onClick={onClick}
     className={`bg-[#228EE5] border-[1px] text-[#EBFAFF] px-5 py-2 flex justify-center items-center gap-2 capitalize cursor-pointer border-[#228EE5]  hover:bg-transparent ${buttonName.toLowerCase() === "watch movie"? "rounded-3xl": "rounded-lg"}`}
     >
